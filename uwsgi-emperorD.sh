...
PATH=/home/pi/Virtualenvs/athomefrb3/bin:/sbin:/bin:/usr/sbin:/usr/bin
DAEMON=/home/pi/Virtualenvs/athomefrb3/bin/uwsgi

NAME=uwsgi-emperor
DESC=uwsgi-emperor

# modify as needed
VASALS=/etc/uwsgi/vassals
